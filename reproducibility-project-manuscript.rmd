...
## Data analysis
A correlation test will be conducted to compute Pearson's *r* for the association between `neuroticism` and `loneliness`. Using the `psych` package (CITE), we will test the hypothesis that the correlation between `neuroticism` and `loneliness` is significantly ($\alpha$ = .001) greater than *r* = .30 in this sample.   
