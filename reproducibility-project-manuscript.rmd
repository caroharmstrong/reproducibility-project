...
# Load simulated data
data_simulated <- read.csv("~/Library/CloudStorage/GoogleDrive-armst874@umn.edu/My Drive/0. Courses/1c. Responsible Research Workflows/Reproducibility Project/neuroticism-loneliness_data-simulated_2025-12-01.csv")
```
...
Using my simulated data, the mean age of participants was `mean(data_simulated$age)` (SD = `sd(data_simulated$age)`). 

```{r descriptives-age, echo=FALSE, message=FALSE, warning=FALSE}
