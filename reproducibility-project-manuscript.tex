...
\subsubsection{Loneliness in Context Survey}\label{loneliness-in-context-survey}
...
A correlation test will be conducted to compute Pearson's \emph{r} for the association between \texttt{neuroticism} and \texttt{loneliness}. Using the \texttt{psych} package (CITE), we will test the hypothesis that the correlation between \texttt{neuroticism} and \texttt{loneliness} is significantly (\(\alpha\) = .001) greater than \emph{r} = .30 in this sample.
...
\subsection{Loneliness in Context Survey (Asher et al., 2009)}\label{loneliness-in-context-survey-asher-et-al.-2009}
