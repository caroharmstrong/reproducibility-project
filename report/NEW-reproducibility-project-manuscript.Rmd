...
ggplot(data_simulated, aes(x = neur_avg_sim)) + 
  ...
  theme_apa() +
  xlab("Mean neuroticism score")
ggplot(data_simulated, aes(x = lic_avg_sim)) + 
  geom_histogram(bins = 20, fill = "black") + 
  theme_apa() +
  xlab("Mean loneliness score")
```
...
The correlation test revealed that there was not a statistically significant correlation between composite neuroticism and loneliness scores ($\rho$ = `r cor_test$estimate`; *p* = `r cor_test$p.value`). See Figure 1.
