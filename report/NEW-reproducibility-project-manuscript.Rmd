...
The following R packages will be used for my analyses (and the writing and producing of this report using the `papaja` template): `r cite_r("r-references.bib")`.
