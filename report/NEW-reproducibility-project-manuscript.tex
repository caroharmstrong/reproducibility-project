...
\pandocbounded{\includegraphics[keepaspectratio]{NEW-reproducibility-project-manuscript_files/figure-latex/histograms-1.pdf}} \pandocbounded{\includegraphics[keepaspectratio]{NEW-reproducibility-project-manuscript_files/figure-latex/histograms-2.pdf}}
...
\begin{table}[t]
\caption{\label{tab:demographics-table}\textbf{Table 1. Demographic Characteristics of Simulated Data}} 
...
The correlation test revealed that there was not a statistically significant correlation between composite neuroticism and loneliness scores (\(\rho\) = 0.00; \emph{p} = 0.51). See Figure 1.

\pandocbounded{\includegraphics[keepaspectratio]{NEW-reproducibility-project-manuscript_files/figure-latex/scatterplot-1.pdf}}
