...
I will compute Spearman's \emph{r} for the association between the composite neuroticism and loneliness scores and test the hypothesis that this correlation is significantly (\(\alpha\) = .001) greater than \emph{r} = .00 in this sample.

I chose to calculate Spearman's \emph{r} because, although the distributions of simulated data for the composite neuroticism and loneliness scores are both approximately normal (an assumption of Pearson's \emph{r}; see below for relevant computations and visualizations), neuroticism and loneliness were measured on ordinal scales (indicating Spearman's \emph{r} would be a more appropriate choice; (Schober, Boer, \& Schwarte, 2018)).

\pandocbounded{\includegraphics[keepaspectratio]{NEW-reproducibility-project-manuscript_files/figure-latex/histogram-1.pdf}} \pandocbounded{\includegraphics[keepaspectratio]{NEW-reproducibility-project-manuscript_files/figure-latex/histogram-2.pdf}}
